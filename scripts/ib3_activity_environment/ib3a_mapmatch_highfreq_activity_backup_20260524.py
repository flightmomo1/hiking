...
OUT_DIR = PROJECT_ROOT / "outputs" / "ib3a_mapmatched_activity" / CASE_ID
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_CSV = OUT_DIR / f"{CASE_ID}_activity_mapmatched.csv"
OUT_GEOJSON = OUT_DIR / f"{CASE_ID}_activity_mapmatched.geojson"
OUT_SUMMARY_TXT = OUT_DIR / f"{CASE_ID}_activity_mapmatched_summary.txt"
OUT_CORE_CSV = OUT_DIR / f"{CASE_ID}_activity_mapmatched_core.csv"
OUT_CORE_GEOJSON = OUT_DIR / f"{CASE_ID}_activity_mapmatched_core.geojson"
