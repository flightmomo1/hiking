...
VERSION = "v1.5.9-osm-source-store-v2-adapter"
STATUS = (
    ...
    "explicit route-polygon clipping unchanged from v1.5.8 + route-layer conservation QA + "
    "OSM element/id preservation QA + hiking/foot relation-member enrichment + explicit-only network fallback"
)
...
def main() -> None:
    ...
    # v1.5.8 storage contract:
    # - NLSC/TILE_FULL owns reusable OSM source authority under <data-dir>/tiles.
