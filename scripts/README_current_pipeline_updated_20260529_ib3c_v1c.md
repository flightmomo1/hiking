...
7. IB3C activity behavior event detection V1c 已完成初版實作與 37_1 / 33_1 驗證：
   已可將低速、停留、off-route exploration/navigation/rejoin candidate、facility rest、HR recovery 與 terminal artifact 輸出為 event-level CSV；後續可再擴充 weather observed/scenario context 與 IB3B2 observed behavior 圖面標註。
   IB3C V1c is implemented and verified for 37_1 / 33_1. Future work should add weather context and observed-behavior visualization overlays.
