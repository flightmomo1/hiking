...
ACTIVITY_NAME = "3.csv"
ACTIVITY_DIR = PROJECT_ROOT / "113國體測試資料" / "juansi_waterfall"
ACTIVITY_FP = ACTIVITY_DIR / ACTIVITY_NAME

# ---------------------------------------------------------
# Ia1 dataset：底層 OSM raw layer 資料集
# ---------------------------------------------------------
IA1_VERSION = "v1.2"
IA1_DATASET_ID = "qixing_lengshuikeng_xiaoyoukeng"
IA1_SNAPSHOT_TAG = "v1_2_success_20260511"
...
# Output
# ---------------------------------------------------------
OUT_DIR = PROJECT_ROOT / "ib0c_anchor_output" / CASE_ID
