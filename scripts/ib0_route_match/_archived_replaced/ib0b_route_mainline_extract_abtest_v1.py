...
# 三位一體活動輸入：
# ACTIVITY_TYPE 可選 "gpx" / "fit_csv" / "csv"
ACTIVITY_TYPE = "fit_csv"
ACTIVITY_NAME = "3.csv"

# 若已依新架構整理到 activity_input，建議使用這行：
ACTIVITY_FP = PROJECT_ROOT / "activity_input" / "csv" / ROUTE_GROUP / ACTIVITY_NAME

# 若暫時還沒搬檔，可先改用舊位置：
# ACTIVITY_FP = PROJECT_ROOT / "113國體測試資料" / "juansi_waterfall" / ACTIVITY_NAME
