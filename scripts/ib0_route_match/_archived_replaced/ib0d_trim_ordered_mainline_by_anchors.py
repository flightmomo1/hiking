...
# 0. 路徑設定
# =========================================================
ORDERED_PATH_FP = Path("ib0b_output/qixing_mainline_ordered_path.geojson")
ANCHOR_FP = Path("ib0c_anchor_output/qixing_route_anchors.geojson")

OUT_DIR = Path("ib0d_output")
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_TRIMMED_GEOJSON = OUT_DIR / "qixing_mainline_ordered_path_trimmed.geojson"
OUT_SUMMARY_CSV = OUT_DIR / "qixing_mainline_trim_summary.csv"
OUT_HTML = OUT_DIR / "qixing_mainline_ordered_path_trimmed_map.html"
