...
# IA1_DATASET_ID = "qixing_lengshuikeng_xiaoyoukeng"
# IA1_DIR = Path("osm_raw_output") / IA1_DATASET_ID


# OUT_DIR = Path("ib1c_route_profile_semantic_output") / CASE_ID
# OUT_DIR.mkdir(parents=True, exist_ok=True)

# OUT_CSV = OUT_DIR / "qixing_route_profile_semantic_enriched.csv"
# OUT_GEOJSON = OUT_DIR / "qixing_route_profile_semantic_enriched.geojson"
...
OUT_DIR = Path("outputs") / "ib1c_route_profile_semantics" / CASE_ID
OUT_DIR.mkdir(parents=True, exist_ok=True)
...
# 線狀/面狀圖層距離門檻
# technical
NEAR_TECHNICAL_M = 40.0

# hazard
NEAR_HAZARD_M = 60.0

# hydrology
NEAR_WATERWAY_M = 35.0
