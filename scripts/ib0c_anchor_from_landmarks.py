...
# 0. 路徑設定
# =========================================================
GPX_DIR = Path("//140.96.152.158/【個人】a50178（新竹限額16gb）/115_osm/2026-05-06/gpx")
GPX_NAME = "冷水坑上-七星山東峰-主峰-下小油坑.gpx"
GPX_FP = GPX_DIR / GPX_NAME

OUT_DIR = Path("ib0c_anchor_output")
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_GEOJSON_FP = OUT_DIR / "qixing_route_anchors.geojson"
OUT_CSV_FP = OUT_DIR / "qixing_route_anchors.csv"
OUT_HTML_FP = OUT_DIR / "qixing_route_anchors_map.html"
...
def find_file(filename: str) -> Path | None:
    ...
    # 優先排除輸出資料夾，避免讀到奇怪副本
    hits = [p for p in hits if "ib0c_anchor_output" not in str(p)]
