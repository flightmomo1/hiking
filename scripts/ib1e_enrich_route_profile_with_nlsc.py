...
NLSC_SEGMENT_FP = Path("segment_enriched_output/97233NW_segments_20m_elevation_enriched.geojson")

OUT_DIR = Path("ib1e_route_profile_nlsc_output")
OUT_DIR.mkdir(parents=True, exist_ok=True)

OUT_CSV = OUT_DIR / "qixing_route_profile_nlsc_enriched.csv"
OUT_GEOJSON = OUT_DIR / "qixing_route_profile_nlsc_enriched.geojson"
...
joined["pipeline_stage"] = "ib1e_enrich_route_profile_with_nlsc"
